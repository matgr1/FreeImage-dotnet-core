...
namespace FreeImageAPI
{
    internal static class FreeImageStaticImportsLinux
    {
        ...
        /// </summary>
        private const string FreeImageLibrary = "libfreeimage";
        ...
        public static unsafe string GetVersion() { return FreeImage.PtrToStr(GetVersion_()); }
        ...
        public static unsafe string GetCopyrightMessage() { return FreeImage.PtrToStr(GetCopyrightMessage_()); }
        ...
        /// </summary>
        /// <remarks>The function is public because FreeImage can only have a single
        ...
        public static unsafe string GetFormatFromFIF(FREE_IMAGE_FORMAT fif) { return FreeImage.PtrToStr(GetFormatFromFIF_(fif)); }
        ...
        public static unsafe string GetFIFExtensionList(FREE_IMAGE_FORMAT fif) { return FreeImage.PtrToStr(GetFIFExtensionList_(fif)); }
        ...
        public static unsafe string GetFIFDescription(FREE_IMAGE_FORMAT fif) { return FreeImage.PtrToStr(GetFIFDescription_(fif)); }
        ...
        public static unsafe string GetFIFRegExpr(FREE_IMAGE_FORMAT fif) { return FreeImage.PtrToStr(GetFIFRegExpr_(fif)); }
        ...
        public static unsafe string GetFIFMimeType(FREE_IMAGE_FORMAT fif) { return FreeImage.PtrToStr(GetFIFMimeType_(fif)); }
        ...
        public static unsafe string GetTagKey(FITAG tag) { return FreeImage.PtrToStr(GetTagKey_(tag)); }
        ...
        public static unsafe string GetTagDescription(FITAG tag) { return FreeImage.PtrToStr(GetTagDescription_(tag)); }
        ...
        public static unsafe string TagToString(FREE_IMAGE_MDMODEL model, FITAG tag, uint Make) { return FreeImage.PtrToStr(TagToString_(model, tag, Make)); }
